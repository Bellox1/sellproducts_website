        ...
        <div class="container-fluid px-3 px-md-5 pt-0 pb-4">
            <div
                ...
                <div class="glass-container p-4 rounded-5 border border-white border-opacity-50 w-100">
                    <p class="text-secondary small ls-2 text-uppercase mb-0 fw-bold" style="letter-spacing: 4px;">Mon
                        Inventaire</p>
                    <h1 class="display-5 display-md-3 fw-bold mb-0 text-dark">Mes Produits.</h1>
                    <p class="fs-5 text-muted mt-3 fw-medium">Gérez votre catalogue de saveurs disponibles sur <span
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div
                                ...
                                @if ($product->image_url)
                                    <div class="card-img-container" style="height: 250px; position: relative;">
                                        <img src="{{ $product->image_url }}"
                                            class="w-100 h-100 object-fit-cover transition-all" alt="{{ $product->nom }}">
                                        <div class="position-absolute top-0 end-0 p-3">
                                            <span
                                                class="badge glass-pill text-dark px-3 py-2 rounded-pill shadow-sm">{{ number_format($product->prix, 2) }}
                                                FCFA</span>
                                        </div>
                                    </div>
                                @else
                                ...
                                <div class="p-3 p-md-5">
                                    ...
                                    <div
                                        class="d-flex flex-column flex-md-row gap-2 gap-md-3 pt-3 border-top border-white border-opacity-50">
                                        <a href="{{ route('produits.edit', $product) }}"
                                            class="btn btn-glass-auth flex-grow-1 text-center py-2">
                                        ...
                                        <form action="{{ route('produits.destroy', $product) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-glass-auth w-100 text-center py-2"
