...
<div class="admin-dashboard-wrapper min-vh-100 py-3 py-md-5" style="background: transparent; color: #1e293b;">
    <div class="container-fluid px-3 px-md-5 pt-0 pb-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4 mb-md-5 gap-4 animate-in">
            ...
            <div class="pb-3 w-100 d-md-flex justify-content-end">
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('stands.commandes', $stand) }}" class="btn btn-glass-auth shadow-sm fw-bold flex-grow-1 flex-md-grow-0 text-center">
        ...
        <div id="orders-section" class="mb-0 pb-5 animate-in" style="animation-delay: 0.1s; position: relative; z-index: 10;">
            <div class="d-flex justify-content-between align-items-center mb-4 px-2">
                <h2 class="fw-bold text-dark mb-0">Dernières Commandes</h2>
                <a href="{{ route('stands.commandes', $stand) }}" class="text-primary fw-bold text-decoration-none small ls-1">
                                    ...
                                    <tr class="border-top">
                                        ...
                                        <td class="text-end text-nowrap">
                                            <div class="dropdown d-inline-block">
                                                <button class="btn btn-sm btn-glass-auth rounded-pill px-3 dropdown-toggle" type="button" data-bs-toggle="dropdown" data-bs-boundary="viewport">
                                                    GÉRER
                                                </button>
                                                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-4 p-2 mt-2">
                                                    ...
                                                    <li class="border-top mt-2 pt-2">
                                                        <a href="{{ route('commandes.show', $commande) }}" class="dropdown-item rounded-3 py-2 small text-muted">
        ...
        <!-- Catalogue Section -->
        <div id="catalog-section" class="d-flex justify-content-between align-items-center mb-5 mt-5 py-5 border-top border-white border-opacity-25 animate-in" style="animation-delay: 0.2s; position: relative; z-index: 5;">
                        ...
                        <div class="glass-container p-0 rounded-5 shadow-sm border border-white h-100 transition-all hover-up overflow-hidden">
                            @if($produit->image_url)
                                <div class="card-img-container" style="height: 180px; position: relative;">
                                    ...
                                    <div class="position-absolute top-0 end-0 p-3">
                                        <span class="badge glass-pill text-dark px-3 py-2 rounded-pill shadow-sm fw-bold">{{ number_format($produit->prix, 2) }} €</span>
                                    </div>
                                </div>
                            @else
                                <div class="card-img-container bg-white bg-opacity-50 d-flex flex-column align-items-center justify-content-center" style="height: 180px;">
                                    <i class="bi bi-image text-secondary opacity-25 mb-2" style="font-size: 2.5rem;"></i>
                                    <div class="position-absolute top-0 end-0 p-3">
                                        <span class="badge glass-pill text-dark px-3 py-2 rounded-pill shadow-sm fw-bold">{{ number_format($produit->prix, 2) }} €</span>
                                    </div>
                                </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="d-flex gap-2 pt-3 border-top border-white border-opacity-50">
                                    <a href="{{ route('produits.edit', $produit) }}" class="btn btn-glass-auth flex-grow-1 text-center py-2 btn-sm">
                                        <i class="bi bi-pencil me-1"></i> ÉDITER
                                    </a>
                                    <form action="{{ route('produits.destroy', $produit) }}" method="POST" class="flex-grow-1">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-glass-auth w-100 text-center py-2 btn-sm" onclick="return confirm('Souhaitez-vous supprimer ce produit ?')">
...
<style>
    ...
    @media (max-width: 767px) {
        .glass-container.p-5 { padding: 1.25rem !important; }
