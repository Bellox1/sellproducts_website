        ...
        <div class="container-fluid px-3 px-md-5 pt-0 pb-4">
            ...
            <div
                ...
                <div class="glass-container p-4 rounded-5 border border-white border-opacity-50 w-100">
                    <p class="text-secondary small ls-2 text-uppercase mb-0 fw-bold" style="letter-spacing: 4px;">
                        {{ $stand->nom_stand }}</p>
            ...
            <!-- Orders Table Card -->
            <div class="glass-container p-4 p-md-5 rounded-5 shadow-sm border border-white animate-in"
                            ...
                            <tbody>
                                @foreach ($commandes as $commande)
                                    <tr class="border-top">
                                        ...
                                        <td class="fw-bold text-dark fs-5">{{ number_format($commande->total, 2) }} FCFA
                                        </td>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('commandes.show', $commande) }}"
                                                class="btn btn-premium-action px-3 py-1 rounded-pill">
